...
void scverify_top::install_observe_foreign_signals() {
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_fir_run_inst_fir_run_staller_inst_run_wen, /scverify_top/rtl/fir_run_inst/fir_run_staller_inst/run_wen);
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_fir_run_inst_fir_run_input_rsci_inst_fir_run_input_rsci_input_wait_ctrl_inst_input_rsci_irdy_run_sct, /scverify_top/rtl/fir_run_inst/fir_run_input_rsci_inst/fir_run_input_rsci_input_wait_ctrl_inst/input_rsci_irdy_run_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_fir_run_inst_fir_run_input_rsci_inst_fir_run_input_rsci_input_wait_ctrl_inst_input_rsci_ivld, /scverify_top/rtl/fir_run_inst/fir_run_input_rsci_inst/fir_run_input_rsci_input_wait_ctrl_inst/input_rsci_ivld);
  OBSERVE_FOREIGN_SIGNAL(OFS_fir_run_inst_fir_run_output_rsci_inst_fir_run_output_rsci_output_wait_ctrl_inst_output_rsci_irdy, /scverify_top/rtl/fir_run_inst/fir_run_output_rsci_inst/fir_run_output_rsci_output_wait_ctrl_inst/output_rsci_irdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_fir_run_inst_fir_run_output_rsci_inst_fir_run_output_rsci_output_wait_ctrl_inst_output_rsci_ivld_run_sct, /scverify_top/rtl/fir_run_inst/fir_run_output_rsci_inst/fir_run_output_rsci_output_wait_ctrl_inst/output_rsci_ivld_run_sct);
#endif
#endif
}
