...
//  
//  Running on Linux m111061545@ws41:8605 3.10.0-1160.95.1.el7.x86_64 x86_64 aol
//  
...
go analyze
go compile
solution library add mgc_Xilinx-KINTEX-uplus-2_beh -- -rtlsyntool Vivado -manufacturer Xilinx -family KINTEX-uplus -speed -2 -part xcku5p-ffvb676-2-e
...
directive set /EdgeDetect_Top/EdgeDetect_MagAng/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /EdgeDetect_Top/EdgeDetect_MagAng/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /EdgeDetect_Top/EdgeDetect_HorDer/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /EdgeDetect_Top/EdgeDetect_HorDer/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /EdgeDetect_Top/EdgeDetect_VerDer/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /EdgeDetect_Top/EdgeDetect_VerDer/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /EdgeDetect_Top/EdgeDetect_VerDer/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /EdgeDetect_Top/EdgeDetect_VerDer/run/line_buf0:rsc -MAP_TO_MODULE {Xilinx_RAMS.BLOCK_1R1W_RBW suppress_sim_read_addr_range_errs=1}
directive set /EdgeDetect_Top/EdgeDetect_VerDer/run/line_buf1:rsc -MAP_TO_MODULE {Xilinx_RAMS.BLOCK_1R1W_RBW suppress_sim_read_addr_range_errs=1}
directive set /EdgeDetect_Top/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /EdgeDetect_Top/dx_chan:cns -FIFO_DEPTH 2
